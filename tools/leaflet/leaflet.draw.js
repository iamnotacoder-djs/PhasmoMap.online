/*
 ...
 http://leafletjs.com
 */
const lang = JSON.parse(document.getElementById("leafletdraw").getAttribute("data-lang"));

 var strings = null;
 $.ajax({
     url: `/tools/langs.json`,
     async: false,
     dataType: 'json',
 ...
 ! function(t, e, i) {
    ...
    L.drawVersion = "1.0.4", L.Draw = {}, L.drawLocal = {
            draw: {
                toolbar: {
                    actions: {
                        title: strings.drawing_cansel_title[lang],
                        text: strings.drawing_cansel[lang]
                    },
                    finish: {
                        title: strings.drawing_finish_title[lang],
                        text: strings.drawing_finish[lang]
                    },
                    undo: {
                        title: strings.drawing_delete_last_point_title[lang],
                        text: strings.drawing_delete_last_point[lang]
                    },
                    buttons: {
                        polyline: strings.drawing_draw_polyline[lang],
                        polygon: strings.drawing_draw_polygon[lang],
                        rectangle: strings.drawing_draw_rectangle[lang],
                        circle: strings.drawing_draw_circle[lang],
                        marker: strings.drawing_draw_marker[lang],
                        circlemarker: strings.drawing_draw_circlemarker[lang]
                    }
                },
                handlers: {
                    circle: {
                        tooltip: {
                            start: strings.drawing_tooltip_circle[lang]
                        },
                        radius: strings.drawing_radius_circle[lang]
                    },
                    circlemarker: {
                        tooltip: {
                            start: strings.drawing_tooltip_circlemarker[lang]
                        }
                    },
                    marker: {
                        tooltip: {
                            start: strings.drawing_tooltip_marker[lang]
                        }
                    },
                    polygon: {
                        tooltip: {
                            start: strings.drawing_tooltip_polygon_start[lang],
                            cont: strings.drawing_tooltip_polygon_cont[lang],
                            end: strings.drawing_tooltip_polygon_end[lang]
                        }
                    },
                    polyline: {
                        error: strings.drawing_error_polyline[lang],
                        tooltip: {
                            start: strings.drawing_tooltip_polyline_start[lang],
                            cont: strings.drawing_tooltip_polyline_cont[lang],
                            end: strings.drawing_tooltip_polyline_end[lang]
                        }
                    },
                    rectangle: {
                        tooltip: {
                            start: strings.drawing_tooltip_rectangle[lang]
                        }
                    },
                    simpleshape: {
                        tooltip: {
                            end: strings.drawing_tooltip_simpleshape[lang]
                        }
                    }
                }
            },
            edit: {
                toolbar: {
                    actions: {
                        save: {
                            title: strings.drawing_edit_toolbar_actions_save_title[lang],
                            text: strings.drawing_edit_toolbar_actions_save_text[lang]
                        },
                        cancel: {
                            title: strings.drawing_edit_toolbar_actions_cancel_title[lang],
                            text: strings.drawing_edit_toolbar_actions_cancel_text[lang]
                        },
                        clearAll: {
                            title: strings.drawing_edit_toolbar_actions_clear_title[lang],
                            text: strings.drawing_edit_toolbar_actions_clear_text[lang]
                        }
                    },
                    buttons: {
                        edit: strings.drawing_edit_toolbar_buttons_edit[lang],
                        editDisabled: strings.drawing_edit_toolbar_buttons_editDisabled[lang],
                        remove: strings.drawing_edit_toolbar_buttons_remove[lang],
                        removeDisabled: strings.drawing_edit_toolbar_buttons_removeDisabled[lang]
                    }
                },
                handlers: {
                    edit: {
                        tooltip: {
                            text: strings.drawing_handlers_edit_tooltip_text[lang],
                            subtext: strings.drawing_handlers_edit_tooltip_subtext[lang]
                        }
                    },
                    remove: {
                        tooltip: {
                            text: strings.drawing_handlers_remove_tooltip_text[lang]
                        }
                    }
                }
            }
